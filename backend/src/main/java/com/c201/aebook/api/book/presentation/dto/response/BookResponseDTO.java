...
public class BookResponseDTO {
    ...
    @Schema(description = "도서 쪽수", defaultValue = "348")
    private int page;
    ...
    @Builder
    public BookResponseDTO(String title, String description, String author, String publisher, Date publishDate, String isbn, int page, int price, String aladinUrl, String coverImageUrl) {
        this.title = title;
